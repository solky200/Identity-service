...
import com.devteria.identityservice.repository.RefreshTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        AuthenticationResponse authenticationResponse = createRefreshToken(user);
    ...
    private AuthenticationResponse createRefreshToken( UsersEntity user)  {
        Date now = new Date();
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request){
        ...
        UsersEntity user = userRepository.findById(refreshTokenEntity.getUserId())
                .orElseThrow(() -> new AppException(ErrorCode.UNAUTHENTICATED));
